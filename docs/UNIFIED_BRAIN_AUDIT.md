...
| **P10** Scenario forecasting | ✅ done | this change | OPTIMISTIC / BASE / CONSERVATIVE + forecast confidence |
| **P11** Freshness ↔ stateVersion | mostly done in P7 | — | remaining: expiry, `forecastVersion` |

### Regression floor after P10

| Check | Result |
|---|---|
| `npm run typecheck` | clean |
| `npm run lint` | 0 problems |
| `npm test` | 88 files, **1279 passed**, 5 skipped (982 baseline + 297 across P4–P10) |
