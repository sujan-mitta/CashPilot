...
| **P6** Unified `FinancialState` | ✅ done | this change | materialised read-through + reconciliation run + write-back |
| **P7** State versioning ↔ freshness | next | — | wire `stateVersion` *alongside* `contextFingerprint`, never replacing it |

### Regression floor after P6

| Check | Result |
|---|---|
| `npm run typecheck` | clean |
| `npm run lint` | 0 problems |
| `npm test` | 80 files, **1131 passed**, 5 skipped (982 baseline + 59 P4 + 41 P5 + 49 P6) |
