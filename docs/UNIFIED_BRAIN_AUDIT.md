...
| **P7** State versioning ↔ freshness | ✅ done | this change | state transition classifier, wired *alongside* the fingerprint in the gate |
| **P8** Unified state → forecast | next | — | **highest-care phase**: behind a flag, parity-tested against current output |

### Regression floor after P7

| Check | Result |
|---|---|
| `npm run typecheck` | clean |
| `npm run lint` | 0 problems |
| `npm test` | 82 files, **1162 passed**, 5 skipped (982 baseline + 59 P4 + 41 P5 + 49 P6 + 31 P7) |
