...
| **P8** ForecastEvent seam | ✅ done | this change | flag-gated pipeline, parity-proven identical; P9's extension point |
| **P9** Customer/supplier behaviour model | next | — | the first phase that intentionally changes a forecast number |

### Regression floor after P8

| Check | Result |
|---|---|
| `npm run typecheck` | clean |
| `npm run lint` | 0 problems |
| `npm test` | 83 files, **1201 passed**, 5 skipped (982 baseline + 59 P4 + 41 P5 + 49 P6 + 31 P7 + 39 P8) |
