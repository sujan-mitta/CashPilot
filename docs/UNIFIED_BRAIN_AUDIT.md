...
| **P9** Behaviour model | ✅ done | this change | payment behaviour + prediction accuracy; **closes the C-1 confidence gap** |
| **P10** Scenario forecasting | next | — | OPTIMISTIC / BASE / CONSERVATIVE, using P9's uncertainty band |

### Regression floor after P9

| Check | Result |
|---|---|
| `npm run typecheck` | clean |
| `npm run lint` | 0 problems |
| `npm test` | 85 files, **1239 passed**, 5 skipped (982 baseline + 257 across P4–P9) |
