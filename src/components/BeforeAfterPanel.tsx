...
export function BeforeAfterPanel({ before, after }: { before: number; after: number }) {
  ...
  return (
    <div className="bg-ground-000 text-white rounded-2xl p-8 relative overflow-hidden shadow-xl max-w-xl mx-auto border border-line-soft">
      <div className="absolute -top-12 -right-12 w-48 h-48 bg-brand-500/20 bg-brand-500/10 rounded-full blur-3xl" />
      <div className="flex justify-between items-center relative z-10">
        <div className="text-center flex-1">
          <span className="text-[10px] uppercase tracking-widest text-ink-300 font-bold block mb-1.5">
            Committed Forecast
          </span>
          <span className="text-3xl font-black text-risk-400">₹{beforeL}L</span>
        ...
        <div className="flex flex-col items-center justify-center px-4">
          ...
          <span className="text-[9px] text-brand-400 uppercase tracking-widest font-black mt-1">
            Intervened
          </span>
        </div>

        <div className="text-center flex-1">
          <span className="text-[10px] uppercase tracking-widest text-brand-400 font-bold block mb-1.5">
            Simulated Outlook
          </span>
          <span className="text-3xl font-black text-safe-400">₹+{afterL}L</span>
